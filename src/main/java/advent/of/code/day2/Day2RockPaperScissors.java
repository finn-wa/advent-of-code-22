 ...
 * storage, a giant Rock Paper Scissors tournament is already in progress.<br>
 * <br>
 ...
 * Elf is called away to help with someone"s tent.<br>
 * <br>
 ...
 * score you would get if you were to follow the strategy guide.<br>
 * <br>
 ...
 * Scissors, giving you a score of 3 + 3 = 6.<br>
 * <br>
 ...
 * the third round, you will defeat your opponent's Scissors with Rock for a score of 1 + 6 = 7.
 * 
...
public class Day2RockPaperScissors extends Day {
	...
	public int part1() {
		return calculateYourTotalScore(getInputPath());
	}

	public int calculateYourTotalScore(Path input) {
	...
	List<Round> parseInput(Path inputPath) {
	...
	Shape[] parseLine(String line) {
		return Arrays.stream(line.strip().split(" "))
			.map(Shape::fromString)
			.toArray(Shape[]::new);
	}
